...
EntityGenerator.prototype.files = function files() {
  ...
  this.template('../../app/templates/Sources/_App/_main.swift', appDir + 'main.swift');
  this.template('Sources/_App/Controllers/_EntityController.swift', routerDir + _s.capitalize(this.name) + 'Controller.swift');
  this.template('Sources/_App/Models/_Entity.swift', modelDir + _s.capitalize(this.name) + '.swift');
  _.each(this.attrs, function (attr) {
    if (attr.attrType === 'Enum') {
      this.attr = attr;
      this.template('Sources/_App/Models/_AttrEnum.swift', modelDir + _s.capitalize(attr.attrName) + 'Enum.swift');
    }
  }.bind(this));
